...
.method public static final fromSlice(Landroid/app/slice/Slice;)Landroidx/credentials/provider/PublicKeyCredentialEntry;
    ...
    .line 410
    invoke-virtual {v0, v1, v2}, Landroidx/credentials/provider/BeginGetPublicKeyCredentialOption$Companion;->createFromEntrySlice$credentials_release(Landroid/os/Bundle;Ljava/lang/String;)Landroidx/credentials/provider/BeginGetPublicKeyCredentialOption;
...
.method public static final toSlice(Landroidx/credentials/provider/PublicKeyCredentialEntry;)Landroid/app/slice/Slice;
    ...
    .line 246
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->getType()Ljava/lang/String;

    move-result-object v0

    .line 247
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->getUsername()Ljava/lang/CharSequence;

    move-result-object v2

    .line 248
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->getDisplayName()Ljava/lang/CharSequence;

    move-result-object v3

    .line 249
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->getPendingIntent()Landroid/app/PendingIntent;

    move-result-object v4

    .line 250
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->getTypeDisplayName()Ljava/lang/CharSequence;

    move-result-object v5

    .line 251
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->getLastUsedTime()Ljava/time/Instant;

    move-result-object v6

    .line 252
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->getIcon()Landroid/graphics/drawable/Icon;

    move-result-object v7

    .line 253
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->isAutoSelectAllowed()Z

    move-result v8

    .line 254
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->getBeginGetCredentialOption()Landroidx/credentials/provider/BeginGetCredentialOption;

    move-result-object v9

    .line 255
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->getEntryGroupId()Ljava/lang/CharSequence;

    move-result-object v10

    .line 256
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->getAffiliatedDomain()Ljava/lang/CharSequence;

    move-result-object v11

    .line 258
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->isDefaultIconPreferredAsSingleProvider()Z
    ...
    .line 308
    :try_start_0
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->hasDefaultIcon()Z
    ...
    :catch_0
    :cond_2
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->isAutoSelectAllowedFromOption()Z
