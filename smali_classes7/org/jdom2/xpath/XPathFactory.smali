...
.method public static final instance()Lorg/jdom2/xpath/XPathFactory;
    ...
    .line 123
    :cond_0
    sget-object v1, Lorg/jdom2/xpath/XPathFactory;->DEFAULTFACTORY:Ljava/lang/String;

    if-nez v1, :cond_1

    new-instance v1, Lorg/jdom2/xpath/jaxen/JaxenXPathFactory;

    invoke-direct {v1}, Lorg/jdom2/xpath/jaxen/JaxenXPathFactory;-><init>()V

    goto :goto_0

    .line 124
    :cond_1
    invoke-static {v1}, Lorg/jdom2/xpath/XPathFactory;->newInstance(Ljava/lang/String;)Lorg/jdom2/xpath/XPathFactory;
