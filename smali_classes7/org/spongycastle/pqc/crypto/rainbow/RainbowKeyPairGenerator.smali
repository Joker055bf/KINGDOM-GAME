...
.method private computePublicKey()V
    ...
    iput-object v9, v0, Lorg/spongycastle/pqc/crypto/rainbow/RainbowKeyPairGenerator;->pub_singular:[[S

    .line 234
    new-array v9, v3, [S

    iput-object v9, v0, Lorg/spongycastle/pqc/crypto/rainbow/RainbowKeyPairGenerator;->pub_scalar:[S
    ...
    invoke-virtual {v11}, Lorg/spongycastle/pqc/crypto/rainbow/Layer;->getCoeffAlpha()[[[S
    ...
    invoke-virtual {v12}, Lorg/spongycastle/pqc/crypto/rainbow/Layer;->getCoeffBeta()[[[S
    ...
    invoke-virtual {v13}, Lorg/spongycastle/pqc/crypto/rainbow/Layer;->getCoeffGamma()[[S
    ...
    iget-object v14, v0, Lorg/spongycastle/pqc/crypto/rainbow/RainbowKeyPairGenerator;->A2:[[S

    aget-object v14, v14, v6

    .line 273
    invoke-virtual {v1, v2, v14}, Lorg/spongycastle/pqc/crypto/rainbow/util/ComputeInField;->multVects([S[S)[[S

    move-result-object v14

    .line 271
    invoke-virtual {v1, v9, v14}, Lorg/spongycastle/pqc/crypto/rainbow/util/ComputeInField;->addSquareMatrix([[S[[S)[[S
    ...
    invoke-virtual {v1, v9, v2}, Lorg/spongycastle/pqc/crypto/rainbow/util/ComputeInField;->multVect(S[S)[S

    move-result-object v2

    .line 276
    iget-object v9, v0, Lorg/spongycastle/pqc/crypto/rainbow/RainbowKeyPairGenerator;->pub_singular:[[S

    aget-object v14, v9, v3

    invoke-virtual {v1, v2, v14}, Lorg/spongycastle/pqc/crypto/rainbow/util/ComputeInField;->addVect([S[S)[S
    ...
    iget-object v9, v0, Lorg/spongycastle/pqc/crypto/rainbow/RainbowKeyPairGenerator;->A2:[[S

    aget-object v9, v9, v6

    invoke-virtual {v1, v2, v9}, Lorg/spongycastle/pqc/crypto/rainbow/util/ComputeInField;->multVect(S[S)[S
    ...
    invoke-static {v2, v9}, Lorg/spongycastle/pqc/crypto/rainbow/util/GF2Field;->multElem(SS)S

    move-result v2

    .line 287
    iget-object v9, v0, Lorg/spongycastle/pqc/crypto/rainbow/RainbowKeyPairGenerator;->pub_scalar:[S
    ...
    .line 289
    invoke-static {v2, v11}, Lorg/spongycastle/pqc/crypto/rainbow/util/GF2Field;->multElem(SS)S

    move-result v2

    .line 287
    invoke-static {v14, v2}, Lorg/spongycastle/pqc/crypto/rainbow/util/GF2Field;->addElem(SS)S
    ...
    invoke-virtual {v1, v6, v8}, Lorg/spongycastle/pqc/crypto/rainbow/util/ComputeInField;->multVect(S[S)[S
    ...
    .line 302
    invoke-virtual {v1, v6, v11}, Lorg/spongycastle/pqc/crypto/rainbow/util/ComputeInField;->multVects([S[S)[[S

    move-result-object v11

    .line 300
    invoke-virtual {v1, v9, v11}, Lorg/spongycastle/pqc/crypto/rainbow/util/ComputeInField;->addSquareMatrix([[S[[S)[[S
    ...
    invoke-virtual {v1, v9, v6}, Lorg/spongycastle/pqc/crypto/rainbow/util/ComputeInField;->multVect(S[S)[S
    ...
    invoke-virtual {v1, v6, v11}, Lorg/spongycastle/pqc/crypto/rainbow/util/ComputeInField;->addVect([S[S)[S
    ...
    invoke-virtual {v1, v6, v9}, Lorg/spongycastle/pqc/crypto/rainbow/util/ComputeInField;->multVect(S[S)[S
    ...
    invoke-static {v6, v9}, Lorg/spongycastle/pqc/crypto/rainbow/util/GF2Field;->multElem(SS)S
    ...
    iget-object v14, v0, Lorg/spongycastle/pqc/crypto/rainbow/RainbowKeyPairGenerator;->b2:[S

    aget-short v14, v14, v3

    .line 318
    invoke-static {v6, v14}, Lorg/spongycastle/pqc/crypto/rainbow/util/GF2Field;->multElem(SS)S

    move-result v6

    .line 316
    invoke-static {v11, v6}, Lorg/spongycastle/pqc/crypto/rainbow/util/GF2Field;->addElem(SS)S
    ...
    invoke-virtual {v1, v3, v6}, Lorg/spongycastle/pqc/crypto/rainbow/util/ComputeInField;->multVect(S[S)[S
    ...
    invoke-virtual {v1, v3, v9}, Lorg/spongycastle/pqc/crypto/rainbow/util/ComputeInField;->addVect([S[S)[S
    ...
    .line 330
    invoke-static {v9, v11}, Lorg/spongycastle/pqc/crypto/rainbow/util/GF2Field;->multElem(SS)S

    move-result v9

    .line 329
    invoke-static {v6, v9}, Lorg/spongycastle/pqc/crypto/rainbow/util/GF2Field;->addElem(SS)S
    ...
    invoke-static {v6, v8}, Lorg/spongycastle/pqc/crypto/rainbow/util/GF2Field;->addElem(SS)S
    ...
    .line 351
    invoke-virtual {v1, v10, v12}, Lorg/spongycastle/pqc/crypto/rainbow/util/ComputeInField;->multMatrix(S[[S)[[S

    move-result-object v10

    .line 350
    invoke-virtual {v1, v11, v10}, Lorg/spongycastle/pqc/crypto/rainbow/util/ComputeInField;->addSquareMatrix([[S[[S)[[S
    ...
    invoke-virtual {v1, v10, v11}, Lorg/spongycastle/pqc/crypto/rainbow/util/ComputeInField;->addVect([S[S)[S
