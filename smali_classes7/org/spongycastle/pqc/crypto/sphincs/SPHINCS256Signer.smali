...
.method crypto_sign(Lorg/spongycastle/pqc/crypto/sphincs/HashFunctions;[B[B)[B
    ...
    .line 207
    invoke-interface {v6, v11, v4, v12}, Lorg/spongycastle/crypto/Digest;->update([BII)V

    .line 209
    array-length v4, v10

    invoke-interface {v6, v10, v2, v4}, Lorg/spongycastle/crypto/Digest;->update([BII)V

    .line 211
    invoke-interface {v6, v15, v2}, Lorg/spongycastle/crypto/Digest;->doFinal([BI)I
