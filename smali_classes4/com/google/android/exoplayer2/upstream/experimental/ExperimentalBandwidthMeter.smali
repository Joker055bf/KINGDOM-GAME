...
.method private constructor <init>(Landroid/content/Context;Ljava/util/Map;Lcom/google/android/exoplayer2/upstream/TimeToFirstByteEstimator;Lcom/google/android/exoplayer2/upstream/experimental/BandwidthEstimator;Z)V
    ...
    iput-object p2, p0, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter;->initialBitrateEstimates:Lcom/google/common/collect/ImmutableMap;
    ...
    iput p2, p0, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter;->networkType:I

    .line 298
    invoke-direct {p0, p2}, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter;->getInitialBitrateEstimateForNetworkType(I)J

    move-result-wide p2

    iput-wide p2, p0, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter;->initialBitrateEstimate:J

    .line 299
    new-instance p2, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter$$ExternalSyntheticLambda0;

    invoke-direct {p2, p0}, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter$$ExternalSyntheticLambda0;-><init>(Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter;)V
...
.method private getInitialBitrateEstimateForNetworkType(I)J
    ...
    .line 412
    iget-object p1, p0, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter;->initialBitrateEstimates:Lcom/google/common/collect/ImmutableMap;
...
.method private declared-synchronized onNetworkTypeChanged(I)V
    ...
    .line 389
    iget p1, p0, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter;->networkTypeOverride:I
    :try_end_1
    ...
    .line 405
    iget-object p1, p0, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter;->bandwidthEstimator:Lcom/google/android/exoplayer2/upstream/experimental/BandwidthEstimator;

    invoke-interface {p1, v0, v1}, Lcom/google/android/exoplayer2/upstream/experimental/BandwidthEstimator;->onNetworkTypeChange(J)V

    .line 406
    iget-object p1, p0, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter;->timeToFirstByteEstimator:Lcom/google/android/exoplayer2/upstream/TimeToFirstByteEstimator;

    invoke-interface {p1}, Lcom/google/android/exoplayer2/upstream/TimeToFirstByteEstimator;->reset()V
    :try_end_2
...
.method public declared-synchronized getBitrateEstimate()J
    ...
    .line 321
    :cond_0
    iget-wide v0, p0, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter;->initialBitrateEstimate:J
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized onBytesTransferred(Lcom/google/android/exoplayer2/upstream/DataSource;Lcom/google/android/exoplayer2/upstream/DataSpec;ZI)V
    ...
    :cond_0
    :try_start_1
    iget-object p2, p0, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter;->bandwidthEstimator:Lcom/google/android/exoplayer2/upstream/experimental/BandwidthEstimator;

    invoke-interface {p2, p1, p4}, Lcom/google/android/exoplayer2/upstream/experimental/BandwidthEstimator;->onBytesTransferred(Lcom/google/android/exoplayer2/upstream/DataSource;I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized onTransferEnd(Lcom/google/android/exoplayer2/upstream/DataSource;Lcom/google/android/exoplayer2/upstream/DataSpec;Z)V
    ...
    invoke-interface {p2, p1}, Lcom/google/android/exoplayer2/upstream/experimental/BandwidthEstimator;->onTransferEnd(Lcom/google/android/exoplayer2/upstream/DataSource;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public onTransferInitializing(Lcom/google/android/exoplayer2/upstream/DataSource;Lcom/google/android/exoplayer2/upstream/DataSpec;Z)V
    ...
    .line 351
    :cond_0
    iget-object p3, p0, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter;->timeToFirstByteEstimator:Lcom/google/android/exoplayer2/upstream/TimeToFirstByteEstimator;

    invoke-interface {p3, p2}, Lcom/google/android/exoplayer2/upstream/TimeToFirstByteEstimator;->onTransferInitializing(Lcom/google/android/exoplayer2/upstream/DataSpec;)V

    .line 352
    iget-object p2, p0, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter;->bandwidthEstimator:Lcom/google/android/exoplayer2/upstream/experimental/BandwidthEstimator;

    invoke-interface {p2, p1}, Lcom/google/android/exoplayer2/upstream/experimental/BandwidthEstimator;->onTransferInitializing(Lcom/google/android/exoplayer2/upstream/DataSource;)V
...
.method public declared-synchronized onTransferStart(Lcom/google/android/exoplayer2/upstream/DataSource;Lcom/google/android/exoplayer2/upstream/DataSpec;Z)V
    ...
    invoke-interface {p3, p2}, Lcom/google/android/exoplayer2/upstream/TimeToFirstByteEstimator;->onTransferStart(Lcom/google/android/exoplayer2/upstream/DataSpec;)V

    .line 362
    iget-object p2, p0, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter;->bandwidthEstimator:Lcom/google/android/exoplayer2/upstream/experimental/BandwidthEstimator;

    invoke-interface {p2, p1}, Lcom/google/android/exoplayer2/upstream/experimental/BandwidthEstimator;->onTransferStart(Lcom/google/android/exoplayer2/upstream/DataSource;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
