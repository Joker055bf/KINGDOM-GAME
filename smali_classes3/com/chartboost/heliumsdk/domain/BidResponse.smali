...
.method public static final write$Self(Lcom/chartboost/heliumsdk/domain/BidResponse;Lkotlinx/serialization/encoding/CompositeEncoder;Lkotlinx/serialization/descriptors/SerialDescriptor;)V
    ...
    iget-object v3, p0, Lcom/chartboost/heliumsdk/domain/BidResponse;->id:Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/chartboost/heliumsdk/domain/BidResponse;->bidId:Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/chartboost/heliumsdk/domain/BidResponse;->currency:Ljava/lang/String;
    ...
    sget-object v4, Lcom/chartboost/heliumsdk/domain/BidInfo$$serializer;->INSTANCE:Lcom/chartboost/heliumsdk/domain/BidInfo$$serializer;
    ...
    iget-object v3, p0, Lcom/chartboost/heliumsdk/domain/BidResponse;->partnerName:Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/chartboost/heliumsdk/domain/BidResponse;->heliumBidId:Ljava/lang/String;
    ...
    :cond_c
    iget-boolean v3, p0, Lcom/chartboost/heliumsdk/domain/BidResponse;->isMediation:Z

    iget-object v5, p0, Lcom/chartboost/heliumsdk/domain/BidResponse;->bidInfoArray:Ljava/util/List;
    ...
    check-cast v5, Lcom/chartboost/heliumsdk/domain/BidInfo;

    if-eqz v5, :cond_d

    invoke-virtual {v5}, Lcom/chartboost/heliumsdk/domain/BidInfo;->getId()Ljava/lang/String;
    ...
    :cond_10
    iget-object v3, p0, Lcom/chartboost/heliumsdk/domain/BidResponse;->partnerPlacementName:Ljava/lang/String;
    ...
    invoke-virtual {v5}, Lcom/chartboost/heliumsdk/domain/BidInfo;->getExt()Lcom/chartboost/heliumsdk/domain/BidInfoExt;

    move-result-object v5

    if-eqz v5, :cond_11

    invoke-virtual {v5}, Lcom/chartboost/heliumsdk/domain/BidInfoExt;->getPartnerPlacementName()Ljava/lang/String;
    ...
    :cond_15
    iget-object v3, p0, Lcom/chartboost/heliumsdk/domain/BidResponse;->lineItemId:Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/chartboost/heliumsdk/domain/BidResponse;->lineItemId:Ljava/lang/String;
    ...
    :cond_18
    iget-wide v7, p0, Lcom/chartboost/heliumsdk/domain/BidResponse;->adRevenue:D
    ...
    invoke-virtual {v3}, Lcom/chartboost/heliumsdk/domain/BidInfoExt;->getAdRevenue()Ljava/lang/Double;
    ...
    invoke-interface {p1, p2, v1, v7, v8}, Lkotlinx/serialization/encoding/CompositeEncoder;->encodeDoubleElement(Lkotlinx/serialization/descriptors/SerialDescriptor;ID)V
    ...
    :cond_1c
    iget-wide v7, p0, Lcom/chartboost/heliumsdk/domain/BidResponse;->cpmPrice:D
    ...
    invoke-virtual {v3}, Lcom/chartboost/heliumsdk/domain/BidInfoExt;->getCpmPrice()Ljava/lang/Double;
    ...
    .line 18
    iget-wide v5, p0, Lcom/chartboost/heliumsdk/domain/BidResponse;->cpmPrice:D
    ...
    :cond_20
    iget-object v3, p0, Lcom/chartboost/heliumsdk/domain/BidResponse;->ilrd:Lkotlinx/serialization/json/JsonElement;
    ...
    invoke-virtual {v5}, Lcom/chartboost/heliumsdk/domain/BidInfoExt;->getIlrd()Lkotlinx/serialization/json/JsonElement;
    ...
    iget-object v4, p0, Lcom/chartboost/heliumsdk/domain/BidResponse;->ilrd:Lkotlinx/serialization/json/JsonElement;
    ...
    :cond_24
    iget-object v3, p0, Lcom/chartboost/heliumsdk/domain/BidResponse;->partnerSettings:Ljava/util/Map;
    ...
    invoke-virtual {v5}, Lcom/chartboost/heliumsdk/domain/BidInfoExt;->getBidderInfo()Lkotlinx/serialization/json/JsonElement;
    ...
    invoke-virtual {v8, v10, v9}, Lkotlinx/serialization/json/Json;->decodeFromJsonElement(Lkotlinx/serialization/DeserializationStrategy;Lkotlinx/serialization/json/JsonElement;)Ljava/lang/Object;
