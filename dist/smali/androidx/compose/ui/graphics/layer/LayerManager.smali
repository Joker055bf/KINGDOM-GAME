...
# direct methods
.method public static synthetic $r8$lambda$4Oc1_o2XEQB0vPg6CtYNjsDH_xs(Landroid/media/ImageReader;)V
    .locals 0
...
.method public static synthetic $r8$lambda$McJgLBTtNdotFCytJHyTmCN8qAM(Landroidx/compose/ui/graphics/layer/LayerManager;Landroid/os/Message;)Z
    .locals 0
...
.method private final persistLayers(Landroidx/collection/ScatterSet;)V
    ...
    .line 107
    invoke-static {v4, v4, v4, v2}, Landroid/media/ImageReader;->newInstance(IIII)Landroid/media/ImageReader;

    move-result-object v2

    .line 113
    new-instance v5, Landroidx/compose/ui/graphics/layer/LayerManager$$ExternalSyntheticLambda0;

    invoke-direct {v5}, Landroidx/compose/ui/graphics/layer/LayerManager$$ExternalSyntheticLambda0;-><init>()V

    .line 115
    iget-object v6, v0, Landroidx/compose/ui/graphics/layer/LayerManager;->handler:Landroid/os/Handler;
    ...
    .line 120
    sget-object v5, Landroidx/compose/ui/graphics/layer/LockHardwareCanvasHelper;->INSTANCE:Landroidx/compose/ui/graphics/layer/LockHardwareCanvasHelper;

    invoke-virtual {v5, v2}, Landroidx/compose/ui/graphics/layer/LockHardwareCanvasHelper;->lockHardwareCanvas(Landroid/view/Surface;)Landroid/graphics/Canvas;

    move-result-object v5

    .line 122
    iput-boolean v4, v0, Landroidx/compose/ui/graphics/layer/LayerManager;->persistenceIterationInProgress:Z

    .line 123
    iget-object v6, v0, Landroidx/compose/ui/graphics/layer/LayerManager;->canvasHolder:Landroidx/compose/ui/graphics/CanvasHolder;
    ...
    .line 125
    invoke-virtual {v5, v3, v3, v4, v4}, Landroid/graphics/Canvas;->clipRect(IIII)Z

    .line 175
    iget-object v9, v1, Landroidx/collection/ScatterSet;->elements:[Ljava/lang/Object;
    ...
    .line 126
    invoke-virtual {v3, v8}, Landroidx/compose/ui/graphics/layer/GraphicsLayer;->drawForPersistence$ui_graphics_release(Landroidx/compose/ui/graphics/Canvas;)V
    ...
    invoke-virtual {v1, v7}, Landroidx/compose/ui/graphics/AndroidCanvas;->setInternalCanvas(Landroid/graphics/Canvas;)V
    ...
    .line 132
    invoke-virtual {v0, v7}, Landroidx/compose/ui/graphics/layer/LayerManager;->release(Landroidx/compose/ui/graphics/layer/GraphicsLayer;)V
