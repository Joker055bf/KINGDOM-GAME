...
.method private assertValid(Ljava/security/Key;Z)V
    ...
    const-string v2, " MUST have a size >= "
    ...
    iget-object v4, v4, Lio/jsonwebtoken/SignatureAlgorithm;->jcaName:Ljava/lang/String;
    ...
    sget-object v4, Lio/jsonwebtoken/SignatureAlgorithm;->HS384:Lio/jsonwebtoken/SignatureAlgorithm;
    ...
    sget-object v4, Lio/jsonwebtoken/SignatureAlgorithm;->HS512:Lio/jsonwebtoken/SignatureAlgorithm;
    ...
    const-string v1, " key\'s algorithm \'"
    ...
    const-string p2, "\' does not equal a valid HmacSHA* algorithm name and cannot be used with "
    ...
    const-string p2, " algorithm.  The JWT JWA Specification (RFC 7518, Section 3.2) states that keys used with "
    ...
    iget p2, p0, Lio/jsonwebtoken/SignatureAlgorithm;->minKeyLength:I

    invoke-virtual {p1, p2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object p1

    const-string p2, " bits (the key size must be greater than or equal to the hash output size).  Consider using the "

    invoke-virtual {p1, p2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    const-class p2, Lio/jsonwebtoken/security/Keys;
    ...
    const-string p2, " class\'s \'secretKeyFor(SignatureAlgorithm."
    ...
    const-string p2, ")\' method to create a key guaranteed to be secure enough for "
    ...
    const-string p2, ".  See https://tools.ietf.org/html/rfc7518#section-3.2 for more information."
    ...
    const-string v6, ")\' method to create a key pair guaranteed to be secure enough for "

    const-string v7, " class\'s \'keyPairFor(SignatureAlgorithm."

    const-string v8, " bits.  Consider using the "
    ...
    const-string v0, " key\'s size (ECParameterSpec order) is "
    ...
    const-string p2, " algorithm.  The JWT JWA Specification (RFC 7518, Section 3.4) states that keys used with "
    ...
    const-string p2, ".  See https://tools.ietf.org/html/rfc7518#section-3.4 for more information."
    ...
    const-string p2, " algorithm.  The JWT JWA Specification (RFC 7518, Section "
    ...
    const-string p2, ") states that keys used with "
...
.method public static forSigningKey(Ljava/security/Key;)Lio/jsonwebtoken/SignatureAlgorithm;
    ...
    const-string v0, " bits.  See https://tools.ietf.org/html/rfc7518#section-3.2 for more information."
