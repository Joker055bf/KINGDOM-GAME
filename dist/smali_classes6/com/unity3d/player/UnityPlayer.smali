...
.field private mGlView:Lcom/unity3d/player/i0;
...
.field private mOnHandleFocusListener:Lcom/unity3d/player/E;
...
.field mSoftInput:Lcom/unity3d/player/S;

.field private mSoftInputTimeoutMilliSeconds:J

.field private mState:Lcom/unity3d/player/W0;

.field private mVideoPlayerProxy:Lcom/unity3d/player/i1;
...
.field private m_FakeListener:Lcom/unity3d/player/Q0;

.field private m_HFPStatus:Lcom/unity3d/player/HFPStatus;

.field private m_IsNoWindowMode:I

.field m_MainThread:Lcom/unity3d/player/U0;

.field private m_NetworkConnectivity:Lcom/unity3d/player/NetworkConnectivity;

.field private m_OnBackPressedDispatcher:Lcom/unity3d/player/C;

.field private m_OrientationLockListener:Lcom/unity3d/player/OrientationLockListener;

.field private m_PhoneCallListener:Lcom/unity3d/player/R0;

.field private m_SplashScreen:Lcom/unity3d/player/a/f;
...
.method static bridge synthetic -$$Nest$fgetmGlView(Lcom/unity3d/player/UnityPlayer;)Lcom/unity3d/player/i0;
    .locals 0

    iget-object p0, p0, Lcom/unity3d/player/UnityPlayer;->mGlView:Lcom/unity3d/player/i0;
...
.method static bridge synthetic -$$Nest$fgetm_SplashScreen(Lcom/unity3d/player/UnityPlayer;)Lcom/unity3d/player/a/f;
    .locals 0

    iget-object p0, p0, Lcom/unity3d/player/UnityPlayer;->m_SplashScreen:Lcom/unity3d/player/a/f;
...
.method static bridge synthetic -$$Nest$fputmVideoPlayerProxy(Lcom/unity3d/player/UnityPlayer;Lcom/unity3d/player/i1;)V
    .locals 0

    iput-object p1, p0, Lcom/unity3d/player/UnityPlayer;->mVideoPlayerProxy:Lcom/unity3d/player/i1;

    return-void
.end method

.method static bridge synthetic -$$Nest$fputm_SplashScreen(Lcom/unity3d/player/UnityPlayer;Lcom/unity3d/player/a/f;)V
    .locals 0

    iput-object p1, p0, Lcom/unity3d/player/UnityPlayer;->m_SplashScreen:Lcom/unity3d/player/a/f;
...
.method static bridge synthetic -$$Nest$mdismissSoftInput(Lcom/unity3d/player/UnityPlayer;)V
    .locals 0

    invoke-direct {p0}, Lcom/unity3d/player/UnityPlayer;->dismissSoftInput()V
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Lcom/unity3d/player/g0;-><init>()V

    invoke-virtual {v0}, Lcom/unity3d/player/g0;->a()V
...
.method public constructor <init>(Landroid/content/Context;Lcom/unity3d/player/IUnityPlayerLifecycleEvents;)V
    ...
    new-instance v3, Lcom/unity3d/player/W0;

    invoke-direct {v3}, Lcom/unity3d/player/W0;-><init>()V

    iput-object v3, p0, Lcom/unity3d/player/UnityPlayer;->mState:Lcom/unity3d/player/W0;
    ...
    new-instance v4, Lcom/unity3d/player/U0;

    invoke-direct {v4, p0, v3}, Lcom/unity3d/player/U0;-><init>(Lcom/unity3d/player/UnityPlayer;Lcom/unity3d/player/U0-IA;)V

    iput-object v4, p0, Lcom/unity3d/player/UnityPlayer;->m_MainThread:Lcom/unity3d/player/U0;

    iput-boolean v1, p0, Lcom/unity3d/player/UnityPlayer;->m_AddPhoneCallListener:Z

    new-instance v4, Lcom/unity3d/player/R0;

    invoke-direct {v4, p0, v3}, Lcom/unity3d/player/R0;-><init>(Lcom/unity3d/player/UnityPlayer;Lcom/unity3d/player/R0-IA;)V

    iput-object v4, p0, Lcom/unity3d/player/UnityPlayer;->m_PhoneCallListener:Lcom/unity3d/player/R0;

    iput-object v3, p0, Lcom/unity3d/player/UnityPlayer;->m_ARCoreApi:Lcom/unity3d/player/GoogleARCoreApi;

    new-instance v4, Lcom/unity3d/player/Q0;

    invoke-direct {v4}, Lcom/unity3d/player/Q0;-><init>()V

    iput-object v4, p0, Lcom/unity3d/player/UnityPlayer;->m_FakeListener:Lcom/unity3d/player/Q0;
    ...
    iput-object v3, p0, Lcom/unity3d/player/UnityPlayer;->m_OnBackPressedDispatcher:Lcom/unity3d/player/C;
    ...
    iput-wide v4, p0, Lcom/unity3d/player/UnityPlayer;->mSoftInputTimeoutMilliSeconds:J

    iput-boolean v2, p0, Lcom/unity3d/player/UnityPlayer;->mProcessKillRequested:Z

    iput-object v3, p0, Lcom/unity3d/player/UnityPlayer;->mSoftInput:Lcom/unity3d/player/S;
    ...
    invoke-static {p2}, Lcom/unity3d/player/g0;->a(Ljava/lang/String;)V
    ...
    invoke-direct {p2, v0, v3}, Lcom/unity3d/player/a/f;-><init>(Landroid/content/Context;I)V

    iput-object p2, p0, Lcom/unity3d/player/UnityPlayer;->m_SplashScreen:Lcom/unity3d/player/a/f;
    ...
    invoke-static {}, Lcom/unity3d/player/W0;->d()Z
    ...
    invoke-direct {v0, p0}, Lcom/unity3d/player/w0;-><init>(Lcom/unity3d/player/UnityPlayer;)V
    ...
    iget-object p2, p0, Lcom/unity3d/player/UnityPlayer;->mState:Lcom/unity3d/player/W0;

    invoke-virtual {p2, v2}, Lcom/unity3d/player/W0;->d(Z)V

    new-instance p2, Lcom/unity3d/player/i0;

    invoke-direct {p2, p1, p0}, Lcom/unity3d/player/i0;-><init>(Landroid/content/Context;Lcom/unity3d/player/UnityPlayer;)V

    iput-object p2, p0, Lcom/unity3d/player/UnityPlayer;->mGlView:Lcom/unity3d/player/i0;

    invoke-virtual {p0, p2}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    iget-object p1, p0, Lcom/unity3d/player/UnityPlayer;->m_SplashScreen:Lcom/unity3d/player/a/f;
    ...
    iget-object p1, p0, Lcom/unity3d/player/UnityPlayer;->m_MainThread:Lcom/unity3d/player/U0;

    invoke-virtual {p1}, Ljava/lang/Thread;->start()V

    new-instance p1, Lcom/unity3d/player/H0;

    invoke-direct {p1, p0}, Lcom/unity3d/player/H0;-><init>(Lcom/unity3d/player/UnityPlayer;)V

    iget-object p2, p0, Lcom/unity3d/player/UnityPlayer;->mActivity:Landroid/app/Activity;

    invoke-static {p2, v2, p1}, Lcom/unity3d/player/D;->a(Ljava/lang/Object;ILjava/lang/Runnable;)Lcom/unity3d/player/C;

    move-result-object p1

    iput-object p1, p0, Lcom/unity3d/player/UnityPlayer;->m_OnBackPressedDispatcher:Lcom/unity3d/player/C;
...
.method private DisableStaticSplashScreen()V
    ...
    invoke-direct {v0, p0}, Lcom/unity3d/player/J0;-><init>(Lcom/unity3d/player/UnityPlayer;)V
...
.method private EarlyEnableFullScreenIfEnabled()V
    ...
    invoke-static {v0}, Lcom/unity3d/player/x;->a(Landroid/app/Activity;)V
...
.method private checkResumePlayer()V
    ...
    :goto_0
    iget-object v1, p0, Lcom/unity3d/player/UnityPlayer;->mState:Lcom/unity3d/player/W0;

    invoke-virtual {v1, v0}, Lcom/unity3d/player/W0;->a(Z)Z
    ...
    :cond_1
    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->mState:Lcom/unity3d/player/W0;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Lcom/unity3d/player/W0;->c(Z)V

    new-instance v0, Lcom/unity3d/player/k0;

    invoke-direct {v0, p0}, Lcom/unity3d/player/k0;-><init>(Lcom/unity3d/player/UnityPlayer;)V

    invoke-virtual {p0, v0}, Lcom/unity3d/player/UnityPlayer;->queueGLThreadEvent(Ljava/lang/Runnable;)V

    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->m_MainThread:Lcom/unity3d/player/U0;

    sget-object v1, Lcom/unity3d/player/S0;->b:Lcom/unity3d/player/S0;

    invoke-static {v0, v1}, Lcom/unity3d/player/U0;->-$$Nest$ma(Lcom/unity3d/player/U0;Lcom/unity3d/player/S0;)V
...
.method private dismissSoftInput()V
    ...
    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->mSoftInput:Lcom/unity3d/player/S;
...
.method private getSoftInputTimeout()J
    ...
    iget-wide v2, p0, Lcom/unity3d/player/UnityPlayer;->mSoftInputTimeoutMilliSeconds:J
...
.method private hidePreservedContent()V
    ...
    invoke-direct {v0, p0}, Lcom/unity3d/player/n0;-><init>(Lcom/unity3d/player/UnityPlayer;)V
...
.method private static loadNative(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {}, Lcom/unity3d/player/W0;->e()V
    ...
    invoke-static {p0, v0}, Lcom/unity3d/player/z;->Log(ILjava/lang/String;)V
...
.method private pauseUnity()V
    ...
    invoke-virtual {p0, v1, v2, v2}, Lcom/unity3d/player/UnityPlayer;->reportSoftInputStr(Ljava/lang/String;IZ)V

    iget-object v1, p0, Lcom/unity3d/player/UnityPlayer;->m_OnBackPressedDispatcher:Lcom/unity3d/player/C;

    const/4 v3, 0x0

    if-eqz v1, :cond_1

    iget-object v4, v1, Lcom/unity3d/player/C;->a:Lcom/unity3d/player/a/c;
    ...
    :goto_0
    iput-boolean v4, v1, Lcom/unity3d/player/C;->c:Z

    invoke-virtual {v1}, Lcom/unity3d/player/C;->unregisterOnBackPressedCallback()V

    :cond_1
    iget-object v1, p0, Lcom/unity3d/player/UnityPlayer;->mState:Lcom/unity3d/player/W0;

    invoke-virtual {v1}, Lcom/unity3d/player/W0;->c()Z
    ...
    invoke-virtual {v1}, Lcom/unity3d/player/W0;->b()Z
    ...
    new-instance v4, Lcom/unity3d/player/O0;

    invoke-direct {v4, p0, v1}, Lcom/unity3d/player/O0;-><init>(Lcom/unity3d/player/UnityPlayer;Ljava/util/concurrent/Semaphore;)V

    goto :goto_1

    :cond_3
    new-instance v4, Lcom/unity3d/player/P0;

    invoke-direct {v4, p0, v1}, Lcom/unity3d/player/P0;-><init>(Lcom/unity3d/player/UnityPlayer;Ljava/util/concurrent/Semaphore;)V

    :goto_1
    iget-object v5, p0, Lcom/unity3d/player/UnityPlayer;->m_MainThread:Lcom/unity3d/player/U0;

    iget-object v6, v5, Lcom/unity3d/player/U0;->a:Landroid/os/Handler;
    ...
    :cond_4
    sget-object v6, Lcom/unity3d/player/S0;->a:Lcom/unity3d/player/S0;

    invoke-static {v5, v6}, Lcom/unity3d/player/U0;->-$$Nest$ma(Lcom/unity3d/player/U0;Lcom/unity3d/player/S0;)V

    iget-object v5, v5, Lcom/unity3d/player/U0;->a:Landroid/os/Handler;

    invoke-static {v5, v4}, Landroid/os/Message;->obtain(Landroid/os/Handler;Ljava/lang/Runnable;)Landroid/os/Message;
    ...
    :try_start_0
    sget-object v5, Lcom/unity3d/player/UnityPlayer$SynchronizationTimeout;->Pause:Lcom/unity3d/player/UnityPlayer$SynchronizationTimeout;

    invoke-virtual {v5}, Lcom/unity3d/player/UnityPlayer$SynchronizationTimeout;->getTimeout()I
    ...
    invoke-virtual {v1, v6, v7, v8}, Ljava/util/concurrent/Semaphore;->tryAcquire(JLjava/util/concurrent/TimeUnit;)Z
    ...
    invoke-static {v4, v0}, Lcom/unity3d/player/z;->Log(ILjava/lang/String;)V
    :try_end_0
    ...
    invoke-virtual {v0, v3}, Lcom/unity3d/player/W0;->c(Z)V

    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->mState:Lcom/unity3d/player/W0;

    invoke-virtual {v0, v2}, Lcom/unity3d/player/W0;->e(Z)V
    ...
    iget-object v1, p0, Lcom/unity3d/player/UnityPlayer;->m_PhoneCallListener:Lcom/unity3d/player/R0;
...
.method private queueGLThreadEvent(Lcom/unity3d/player/V0;)V
    .locals 1
...
.method private raiseFocusListener(Z)V
    ...
    iget-object p1, p0, Lcom/unity3d/player/UnityPlayer;->mOnHandleFocusListener:Lcom/unity3d/player/E;

    if-eqz p1, :cond_0

    check-cast p1, Lcom/unity3d/player/o0;

    iget-object p1, p1, Lcom/unity3d/player/o0;->a:Lcom/unity3d/player/q0;

    const/4 v0, 0x1

    iput-boolean v0, p1, Lcom/unity3d/player/q0;->b:Z

    iget-boolean v0, p1, Lcom/unity3d/player/q0;->a:Z

    if-eqz v0, :cond_0

    iget-object p1, p1, Lcom/unity3d/player/q0;->c:Ljava/util/concurrent/Semaphore;
...
.method private setBackButtonLeavesApp(Z)V
    ...
    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->m_OnBackPressedDispatcher:Lcom/unity3d/player/C;
...
.method private shutdown()V
    ...
    invoke-virtual {v0, v1}, Lcom/unity3d/player/W0;->d(Z)V
...
.method private startActivityIndicator(I)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/unity3d/player/G0;-><init>(Lcom/unity3d/player/UnityPlayer;I)V
...
.method private stopActivityIndicator()V
    ...
    invoke-direct {v0}, Lcom/unity3d/player/I0;-><init>()V
...
.method private swapViews(Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-virtual {v0}, Lcom/unity3d/player/W0;->b()Z
...
.method private static unloadNative()V
    ...
    invoke-static {}, Lcom/unity3d/player/W0;->f()V
...
.method private updateDisplayInternal(ILandroid/view/Surface;)Z
    ...
    invoke-virtual {v1}, Lcom/unity3d/player/W0;->a()Z
    ...
    invoke-direct {v2, p0, p1, p2, v1}, Lcom/unity3d/player/L0;-><init>(Lcom/unity3d/player/UnityPlayer;ILandroid/view/Surface;Ljava/util/concurrent/Semaphore;)V

    if-nez p1, :cond_4

    iget-object v3, p0, Lcom/unity3d/player/UnityPlayer;->m_MainThread:Lcom/unity3d/player/U0;

    iget-object v4, v3, Lcom/unity3d/player/U0;->a:Landroid/os/Handler;
    ...
    invoke-static {v3, v4}, Lcom/unity3d/player/U0;->-$$Nest$ma(Lcom/unity3d/player/U0;Lcom/unity3d/player/S0;)V

    iget-object v3, v3, Lcom/unity3d/player/U0;->a:Landroid/os/Handler;
    ...
    sget-object v2, Lcom/unity3d/player/S0;->e:Lcom/unity3d/player/S0;

    invoke-static {v3, v2}, Lcom/unity3d/player/U0;->-$$Nest$ma(Lcom/unity3d/player/U0;Lcom/unity3d/player/S0;)V

    goto :goto_0

    :cond_4
    invoke-virtual {v2}, Lcom/unity3d/player/L0;->run()V
...
.method public addViewToPlayer(Landroid/view/View;Z)Z
    ...
    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->mGlView:Lcom/unity3d/player/i0;
    ...
    iget-object p2, p0, Lcom/unity3d/player/UnityPlayer;->mGlView:Lcom/unity3d/player/i0;
    ...
    :goto_2
    iget-object v2, p0, Lcom/unity3d/player/UnityPlayer;->mGlView:Lcom/unity3d/player/i0;
    ...
    invoke-static {v1, p1}, Lcom/unity3d/player/z;->Log(ILjava/lang/String;)V
...
.method public configurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, Lcom/unity3d/player/UnityPlayer;->mVideoPlayerProxy:Lcom/unity3d/player/i1;

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lcom/unity3d/player/i1;->a()V
...
.method public destroy()V
    ...
    iput-object v1, p0, Lcom/unity3d/player/UnityPlayer;->m_OnBackPressedDispatcher:Lcom/unity3d/player/C;
    ...
    sget-object v1, Lcom/unity3d/player/S0;->c:Lcom/unity3d/player/S0;
...
.method public displayChanged(ILandroid/view/Surface;)Z
    ...
    invoke-direct {v0, p0}, Lcom/unity3d/player/M0;-><init>(Lcom/unity3d/player/UnityPlayer;)V
...
.method protected hideSoftInput()V
    ...
    iget-object v1, p0, Lcom/unity3d/player/UnityPlayer;->mSoftInput:Lcom/unity3d/player/S;
    ...
    invoke-virtual {p0, v1}, Lcom/unity3d/player/UnityPlayer;->reportSoftInputIsVisible(Z)V
    ...
    iput-object v4, p0, Lcom/unity3d/player/UnityPlayer;->mSoftInput:Lcom/unity3d/player/S;
    ...
    new-instance v1, Lcom/unity3d/player/q0;

    invoke-direct {v1, p0, v2, p0}, Lcom/unity3d/player/q0;-><init>(Lcom/unity3d/player/UnityPlayer;Ljava/util/concurrent/Semaphore;Lcom/unity3d/player/UnityPlayer;)V
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/unity3d/player/UnityPlayer;->getSoftInputTimeout()J
...
.method public newIntent(Landroid/content/Intent;)V
    ...
    sget-object v0, Lcom/unity3d/player/S0;->i:Lcom/unity3d/player/S0;

    invoke-static {p1, v0}, Lcom/unity3d/player/U0;->-$$Nest$ma(Lcom/unity3d/player/U0;Lcom/unity3d/player/S0;)V
...
.method public onGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Lcom/unity3d/player/i0;->c()Z
...
.method protected pauseJavaAndCallUnloadCallback()V
    ...
    invoke-direct {v0, p0}, Lcom/unity3d/player/C0;-><init>(Lcom/unity3d/player/UnityPlayer;)V
...
.method queueGLThreadEvent(Ljava/lang/Runnable;)V
    ...
    iget-object v1, p0, Lcom/unity3d/player/UnityPlayer;->m_MainThread:Lcom/unity3d/player/U0;
...
.method public reportError(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p2, p1}, Lcom/unity3d/player/z;->Log(ILjava/lang/String;)V
...
.method protected reportSoftInputArea(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/unity3d/player/y0;-><init>(Lcom/unity3d/player/UnityPlayer;Landroid/graphics/Rect;)V

    invoke-direct {p0, v0}, Lcom/unity3d/player/UnityPlayer;->queueGLThreadEvent(Lcom/unity3d/player/V0;)V
...
.method protected reportSoftInputIsVisible(Z)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/unity3d/player/z0;-><init>(Lcom/unity3d/player/UnityPlayer;Z)V
...
.method protected reportSoftInputSelection(II)V
    ...
    invoke-direct {v0, p0, p1, p2}, Lcom/unity3d/player/x0;-><init>(Lcom/unity3d/player/UnityPlayer;II)V
...
.method protected reportSoftInputStr(Ljava/lang/String;IZ)V
    ...
    invoke-direct {v0, p0, p3, p1, p2}, Lcom/unity3d/player/v0;-><init>(Lcom/unity3d/player/UnityPlayer;ZLjava/lang/String;I)V
...
.method sendSurfaceChangedEvent()V
    ...
    invoke-virtual {v0}, Lcom/unity3d/player/W0;->a()Z
    ...
    iget-object v1, v1, Lcom/unity3d/player/U0;->a:Landroid/os/Handler;
...
.method protected setCharacterLimit(I)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/unity3d/player/s0;-><init>(Lcom/unity3d/player/UnityPlayer;I)V
...
.method protected setHideInputField(Z)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/unity3d/player/t0;-><init>(Lcom/unity3d/player/UnityPlayer;Z)V
...
.method public setMainSurfaceViewAspectRatio(F)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/unity3d/player/E0;-><init>(Lcom/unity3d/player/UnityPlayer;F)V
...
.method public setOnHandleFocusListener(Lcom/unity3d/player/E;)V
    .locals 0

    iput-object p1, p0, Lcom/unity3d/player/UnityPlayer;->mOnHandleFocusListener:Lcom/unity3d/player/E;
...
.method public setScreenBrightness(F)V
    ...
    :cond_0
    new-instance v0, Lcom/unity3d/player/F0;

    invoke-direct {v0, p0, p1}, Lcom/unity3d/player/F0;-><init>(Lcom/unity3d/player/UnityPlayer;F)V
...
.method protected setSelection(II)V
    ...
    invoke-direct {v0, p0, p1, p2}, Lcom/unity3d/player/u0;-><init>(Lcom/unity3d/player/UnityPlayer;II)V
...
.method protected setSoftInputStr(Ljava/lang/String;)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/unity3d/player/r0;-><init>(Lcom/unity3d/player/UnityPlayer;Ljava/lang/String;)V
...
.method protected setupUnityToBePaused()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->mVideoPlayerProxy:Lcom/unity3d/player/i1;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lcom/unity3d/player/i1;->b()V
...
.method protected setupUnityToBeResumed()V
    ...
    invoke-virtual {v0, v1}, Lcom/unity3d/player/W0;->e(Z)V

    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->mVideoPlayerProxy:Lcom/unity3d/player/i1;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lcom/unity3d/player/i1;->c()V
    ...
    iget-boolean v1, v0, Lcom/unity3d/player/C;->c:Z
...
.method protected showSoftInput(Ljava/lang/String;IZZZZLjava/lang/String;IZZ)V
    ...
    invoke-direct {v15, v1}, Ljava/util/concurrent/Semaphore;-><init>(I)V

    new-instance v14, Lcom/unity3d/player/m0;
    ...
    invoke-direct/range {v1 .. v14}, Lcom/unity3d/player/m0;-><init>(Lcom/unity3d/player/UnityPlayer;Lcom/unity3d/player/UnityPlayer;Ljava/lang/String;IZZZZLjava/lang/String;IZZLjava/util/concurrent/Semaphore;)V

    move-object/from16 v1, p0

    invoke-virtual {v1, v0}, Lcom/unity3d/player/UnityPlayer;->postOnUiThread(Ljava/lang/Runnable;)V

    const/4 v0, 0x6

    :try_start_0
    invoke-direct/range {p0 .. p0}, Lcom/unity3d/player/UnityPlayer;->getSoftInputTimeout()J

    move-result-wide v2

    sget-object v4, Ljava/util/concurrent/TimeUnit;->MILLISECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v15, v2, v3, v4}, Ljava/util/concurrent/Semaphore;->tryAcquire(JLjava/util/concurrent/TimeUnit;)Z
    ...
    invoke-static {v0, v2}, Lcom/unity3d/player/z;->Log(ILjava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/InterruptedException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :catch_0
    const-string v2, "UI thread got interrupted while waiting softinput showing operation."
...
.method protected showVideoPlayer(Ljava/lang/String;IIIZII)Z
    ...
    iget-object v1, v0, Lcom/unity3d/player/UnityPlayer;->mVideoPlayerProxy:Lcom/unity3d/player/i1;

    if-nez v1, :cond_0

    new-instance v1, Lcom/unity3d/player/i1;

    invoke-direct {v1, p0}, Lcom/unity3d/player/i1;-><init>(Lcom/unity3d/player/UnityPlayer;)V

    iput-object v1, v0, Lcom/unity3d/player/UnityPlayer;->mVideoPlayerProxy:Lcom/unity3d/player/i1;

    :cond_0
    iget-object v2, v0, Lcom/unity3d/player/UnityPlayer;->mVideoPlayerProxy:Lcom/unity3d/player/i1;
    ...
    new-instance v13, Lcom/unity3d/player/A0;

    invoke-direct {v13, p0}, Lcom/unity3d/player/A0;-><init>(Lcom/unity3d/player/UnityPlayer;)V
    ...
    invoke-virtual/range {v2 .. v13}, Lcom/unity3d/player/i1;->a(Landroid/content/Context;Ljava/lang/String;IIIZJJLcom/unity3d/player/h1;)Z
    ...
    invoke-direct {v2, p0}, Lcom/unity3d/player/B0;-><init>(Lcom/unity3d/player/UnityPlayer;)V
...
.method public startOrientationListener(I)Z
    ...
    :goto_0
    invoke-static {v2, p1}, Lcom/unity3d/player/z;->Log(ILjava/lang/String;)V
    ...
    invoke-direct {v0, p0, v3, p1}, Lcom/unity3d/player/D0;-><init>(Lcom/unity3d/player/UnityPlayer;Landroid/content/Context;I)V
...
.method protected toggleGyroscopeSensor(Z)V
    ...
    iget-object p1, p0, Lcom/unity3d/player/UnityPlayer;->m_FakeListener:Lcom/unity3d/player/Q0;
...
.method public windowFocusChanged(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/unity3d/player/W0;->b(Z)V
    ...
    :cond_1
    sget-object v1, Lcom/unity3d/player/S0;->f:Lcom/unity3d/player/S0;

    :goto_0
    invoke-static {v0, v1}, Lcom/unity3d/player/U0;->-$$Nest$ma(Lcom/unity3d/player/U0;Lcom/unity3d/player/S0;)V

    invoke-direct {p0, p1}, Lcom/unity3d/player/UnityPlayer;->raiseFocusListener(Z)V
