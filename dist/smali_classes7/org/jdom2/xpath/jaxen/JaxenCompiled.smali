...
.method public constructor <init>(Ljava/lang/String;Lorg/jdom2/filter/Filter;Ljava/util/Map;[Lorg/jdom2/Namespace;)V
    ...
    .line 150
    :try_start_0
    new-instance p3, Lorg/jaxen/BaseXPath;

    invoke-direct {p3, p1, p2}, Lorg/jaxen/BaseXPath;-><init>(Ljava/lang/String;Lorg/jaxen/Navigator;)V

    iput-object p3, p0, Lorg/jdom2/xpath/jaxen/JaxenCompiled;->xPath:Lorg/jaxen/XPath;
    :try_end_0
    .catch Lorg/jaxen/JaxenException; {:try_start_0 .. :try_end_0} :catch_0

    .line 155
    invoke-interface {p3, p0}, Lorg/jaxen/XPath;->setNamespaceContext(Lorg/jaxen/NamespaceContext;)V

    .line 156
    invoke-interface {p3, p0}, Lorg/jaxen/XPath;->setVariableContext(Lorg/jaxen/VariableContext;)V
