.class public final Lcom/chartboost/heliumsdk/network/ChartboostMediationNetworking$getAppConfig$$inlined$safeApiCall$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/chartboost/heliumsdk/network/ChartboostMediationNetworking;->getAppConfig(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
.end annotation
...
.annotation runtime Lkotlin/coroutines/jvm/internal/DebugMetadata;
    c = "com.chartboost.heliumsdk.network.ChartboostMediationNetworking$getAppConfig$$inlined$safeApiCall$1"
...
.field final synthetic $initHash$inlined:Ljava/lang/String;
...
.method public constructor <init>(Lkotlin/coroutines/Continuation;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lcom/chartboost/heliumsdk/network/ChartboostMediationNetworking$getAppConfig$$inlined$safeApiCall$1;->$appId$inlined:Ljava/lang/String;

    iput-object p3, p0, Lcom/chartboost/heliumsdk/network/ChartboostMediationNetworking$getAppConfig$$inlined$safeApiCall$1;->$initHash$inlined:Ljava/lang/String;

    iput-object p4, p0, Lcom/chartboost/heliumsdk/network/ChartboostMediationNetworking$getAppConfig$$inlined$safeApiCall$1;->$appSetId$inlined:Ljava/lang/String;
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    new-instance p1, Lcom/chartboost/heliumsdk/network/ChartboostMediationNetworking$getAppConfig$$inlined$safeApiCall$1;

    iget-object v0, p0, Lcom/chartboost/heliumsdk/network/ChartboostMediationNetworking$getAppConfig$$inlined$safeApiCall$1;->$appId$inlined:Ljava/lang/String;

    iget-object v1, p0, Lcom/chartboost/heliumsdk/network/ChartboostMediationNetworking$getAppConfig$$inlined$safeApiCall$1;->$initHash$inlined:Ljava/lang/String;

    iget-object v2, p0, Lcom/chartboost/heliumsdk/network/ChartboostMediationNetworking$getAppConfig$$inlined$safeApiCall$1;->$appSetId$inlined:Ljava/lang/String;

    invoke-direct {p1, p2, v0, v1, v2}, Lcom/chartboost/heliumsdk/network/ChartboostMediationNetworking$getAppConfig$$inlined$safeApiCall$1;-><init>(Lkotlin/coroutines/Continuation;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/chartboost/heliumsdk/network/ChartboostMediationNetworking$getAppConfig$$inlined$safeApiCall$1;->invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/chartboost/heliumsdk/network/ChartboostMediationNetworking$getAppConfig$$inlined$safeApiCall$1;->create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;

    move-result-object p1

    check-cast p1, Lcom/chartboost/heliumsdk/network/ChartboostMediationNetworking$getAppConfig$$inlined$safeApiCall$1;

    sget-object p2, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {p1, p2}, Lcom/chartboost/heliumsdk/network/ChartboostMediationNetworking$getAppConfig$$inlined$safeApiCall$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget v2, p0, Lcom/chartboost/heliumsdk/network/ChartboostMediationNetworking$getAppConfig$$inlined$safeApiCall$1;->label:I
    ...
    sget-object v6, Lcom/chartboost/heliumsdk/network/Endpoints$Sdk;->SDK_INIT:Lcom/chartboost/heliumsdk/network/Endpoints$Sdk;

    invoke-virtual {v6}, Lcom/chartboost/heliumsdk/network/Endpoints$Sdk;->getEndpoint()Ljava/lang/String;
    ...
    iget-object v6, p0, Lcom/chartboost/heliumsdk/network/ChartboostMediationNetworking$getAppConfig$$inlined$safeApiCall$1;->$appId$inlined:Ljava/lang/String;
    ...
    .line 407
    new-instance v6, Lcom/chartboost/heliumsdk/network/model/ChartboostMediationHeaderMap$ChartboostMediationAppConfigHeaderMap;

    iget-object v7, p0, Lcom/chartboost/heliumsdk/network/ChartboostMediationNetworking$getAppConfig$$inlined$safeApiCall$1;->$initHash$inlined:Ljava/lang/String;

    iget-object v8, p0, Lcom/chartboost/heliumsdk/network/ChartboostMediationNetworking$getAppConfig$$inlined$safeApiCall$1;->$appSetId$inlined:Ljava/lang/String;

    invoke-direct {v6, v7, v8}, Lcom/chartboost/heliumsdk/network/model/ChartboostMediationHeaderMap$ChartboostMediationAppConfigHeaderMap;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    .line 405
    iput v4, p0, Lcom/chartboost/heliumsdk/network/ChartboostMediationNetworking$getAppConfig$$inlined$safeApiCall$1;->label:I

    invoke-interface {p1, v2, v6, p0}, Lcom/chartboost/heliumsdk/network/ChartboostMediationApi;->getConfig(Ljava/lang/String;Lcom/chartboost/heliumsdk/network/model/ChartboostMediationHeaderMap$ChartboostMediationAppConfigHeaderMap;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 417
    sget-object v7, Lcom/chartboost/heliumsdk/domain/AppConfig;->Companion:Lcom/chartboost/heliumsdk/domain/AppConfig$Companion;

    invoke-virtual {v7}, Lcom/chartboost/heliumsdk/domain/AppConfig$Companion;->serializer()Lkotlinx/serialization/KSerializer;
