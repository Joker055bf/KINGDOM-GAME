...
# static fields
.field private static final SDK_VERSION:Ljava/lang/String; = "19.6.0"
...
.method private assertUnfrozen(Ljava/lang/String;)V
    ...
    const-string v1, "() must be made before any other usage of FirebaseDatabase instance."
...
.method public static declared-synchronized getInstance(Lcom/google/firebase/FirebaseApp;Ljava/lang/String;)Lcom/google/firebase/database/FirebaseDatabase;
    ...
    const-string v0, "\' is invalid. It should point to the root of a Firebase Database but it includes a path: "

    invoke-virtual {p1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    iget-object v0, v2, Lcom/google/firebase/database/core/utilities/ParsedUrl;->path:Lcom/google/firebase/database/core/Path;

    .line 125
    invoke-virtual {v0}, Lcom/google/firebase/database/core/Path;->toString()Ljava/lang/String;
...
.method public getReferenceFromUrl(Ljava/lang/String;)Lcom/google/firebase/database/DatabaseReference;
    ...
    const-string v1, ") passed to getReference().  URL was expected to match configured Database URL: "
