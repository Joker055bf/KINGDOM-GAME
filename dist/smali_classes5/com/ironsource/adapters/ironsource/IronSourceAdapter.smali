...
.field private static final VERSION:Ljava/lang/String; = "7.2.7"
...
.method private createBannerAdInstance(Ljava/lang/String;Lcom/ironsource/sdk/a;Lorg/json/JSONObject;)Lcom/ironsource/sdk/b;
    .locals 4
    ...
    :goto_0
    new-instance v2, Lcom/ironsource/sdk/c;

    invoke-direct {v2, p1, v0}, Lcom/ironsource/sdk/c;-><init>(Ljava/lang/String;Lcom/ironsource/sdk/j/a;)V

    invoke-direct {p0}, Lcom/ironsource/adapters/ironsource/IronSourceAdapter;->getInitParams()Ljava/util/HashMap;

    move-result-object p1

    iput-object p1, v2, Lcom/ironsource/sdk/c;->d:Ljava/util/Map;

    iput-boolean p3, v2, Lcom/ironsource/sdk/c;->b:Z

    iput-boolean v1, v2, Lcom/ironsource/sdk/c;->e:Z

    iput-object p2, v2, Lcom/ironsource/sdk/c;->c:Lcom/ironsource/sdk/a;

    invoke-virtual {v2}, Lcom/ironsource/sdk/c;->a()Lcom/ironsource/sdk/b;
...
.method private createBannerLoadParams(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/util/HashMap;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private getAdInstance(Ljava/lang/String;ZZZ)Lcom/ironsource/sdk/b;
    ...
    new-instance v0, Lcom/ironsource/sdk/c;
    ...
    invoke-direct {v0, p1, v1}, Lcom/ironsource/sdk/c;-><init>(Ljava/lang/String;Lcom/ironsource/sdk/j/a;)V

    invoke-direct {p0}, Lcom/ironsource/adapters/ironsource/IronSourceAdapter;->getInitParams()Ljava/util/HashMap;

    move-result-object p2

    iput-object p2, v0, Lcom/ironsource/sdk/c;->d:Ljava/util/Map;

    const/4 p2, 0x1

    iput-boolean p2, v0, Lcom/ironsource/sdk/c;->a:Z
    ...
    invoke-direct {p2, v1, p1}, Lcom/ironsource/adapters/ironsource/IronSourceInterstitialListener;-><init>(Lcom/ironsource/mediationsdk/sdk/InterstitialSmashListener;Ljava/lang/String;)V

    invoke-direct {v0, p1, p2}, Lcom/ironsource/sdk/c;-><init>(Ljava/lang/String;Lcom/ironsource/sdk/j/a;)V
    ...
    :goto_1
    iput-boolean p3, v0, Lcom/ironsource/sdk/c;->b:Z

    invoke-virtual {v0}, Lcom/ironsource/sdk/c;->a()Lcom/ironsource/sdk/b;
...
.method private loadBannerInternal(Lcom/ironsource/mediationsdk/ISBannerSize;Lorg/json/JSONObject;Lcom/ironsource/mediationsdk/sdk/BannerSmashListener;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1, p1}, Lcom/ironsource/adapters/ironsource/IronSourceAdapter;->convertBannerSize(Landroid/app/Activity;Lcom/ironsource/mediationsdk/ISBannerSize;)Lcom/ironsource/sdk/a;
    ...
    :cond_0
    invoke-direct {p0, p2, p4}, Lcom/ironsource/adapters/ironsource/IronSourceAdapter;->createBannerLoadParams(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/util/HashMap;

    move-result-object p4

    invoke-direct {p0, p4}, Lcom/ironsource/adapters/ironsource/IronSourceAdapter;->printInstanceExtraParams(Ljava/util/Map;)V
    ...
    invoke-direct {p0, v0, p1, p2}, Lcom/ironsource/adapters/ironsource/IronSourceAdapter;->createBannerAdInstance(Ljava/lang/String;Lcom/ironsource/sdk/a;Lorg/json/JSONObject;)Lcom/ironsource/sdk/b;

    move-result-object p1

    invoke-static {v1, p1, p4}, Lcom/ironsource/sdk/IronSourceNetwork;->loadAd(Landroid/app/Activity;Lcom/ironsource/sdk/b;Ljava/util/Map;)V
    :try_end_0
...
.method public destroyBanner(Lorg/json/JSONObject;)V
    ...
    check-cast v1, Lcom/ironsource/sdk/b;

    invoke-static {v1}, Lcom/ironsource/sdk/IronSourceNetwork;->destroyAd(Lcom/ironsource/sdk/b;)V
...
.method public earlyInit(Ljava/lang/String;Ljava/lang/String;Lorg/json/JSONObject;)V
    ...
    iget-object p1, p1, Lcom/ironsource/mediationsdk/L;->j:Ljava/lang/String;
