...
.method public static a(Ljava/lang/String;Ljava/util/List;)Lcom/ironsource/mediationsdk/c/b;
    .locals 2
    ...
    check-cast p0, Lcom/ironsource/mediationsdk/c/b;
...
.method static a(Lorg/json/JSONObject;)Lcom/ironsource/mediationsdk/f$a;
    ...
    invoke-direct {v2, v0}, Lcom/ironsource/mediationsdk/c/b;-><init>(Lorg/json/JSONObject;)V

    iput-object v2, v1, Lcom/ironsource/mediationsdk/f$a;->c:Lcom/ironsource/mediationsdk/c/b;
    ...
    invoke-direct {v2, v4, v3}, Lcom/ironsource/mediationsdk/c/b;-><init>(Lorg/json/JSONObject;Lorg/json/JSONObject;)V

    invoke-virtual {v2}, Lcom/ironsource/mediationsdk/c/b;->h()Z
...
.method private d(Lorg/json/JSONObject;Ljava/util/List;)Lorg/json/JSONObject;
    ...
    sget-object p2, Lcom/ironsource/environment/m;->a:Ljava/util/ArrayList;
...
# virtual methods
.method public final a(Ljava/lang/String;ILcom/ironsource/mediationsdk/c/b;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    .locals 9

    invoke-virtual {p3}, Lcom/ironsource/mediationsdk/c/b;->d()Ljava/lang/String;
    ...
    :goto_1
    invoke-virtual {p3}, Lcom/ironsource/mediationsdk/c/b;->a()Ljava/lang/String;
...
.method final a(Landroid/content/Context;Ljava/util/Map;Ljava/util/List;Lcom/ironsource/mediationsdk/j;ILjava/lang/String;Lcom/ironsource/mediationsdk/utils/c;Lcom/ironsource/mediationsdk/ISBannerSize;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    invoke-direct {v6, v10}, Lorg/json/JSONObject;-><init>(Ljava/util/Map;)V

    const-string v10, "biddingAdditionalData"

    invoke-virtual {v8, v10, v6}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    if-eqz v0, :cond_0

    invoke-virtual {p4, v4}, Lcom/ironsource/mediationsdk/j;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v9, v6, v3}, Lorg/json/JSONObject;->put(Ljava/lang/String;I)Lorg/json/JSONObject;

    if-eqz v0, :cond_2

    invoke-virtual {p4, v8}, Lcom/ironsource/mediationsdk/j;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lcom/ironsource/d/b;->d()Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v5, v5, Lcom/ironsource/mediationsdk/L;->k:Ljava/lang/String;
    ...
    invoke-virtual {v0, v8, v5}, Lorg/json/JSONObject;->put(Ljava/lang/String;I)Lorg/json/JSONObject;
